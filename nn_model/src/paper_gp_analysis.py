...
rospy.init_node('verification_acrobot', anonymous=True)

path = '/home/pracsys/catkin_ws/src/beliefspaceplanning/nn_model/src/results/'


TR = [tr]#['1','2','3'] #
for tr in TR:

    with open('/home/pracsys/catkin_ws/src/beliefspaceplanning/nn_model/data/acrobot_ao_rrt_plan' + tr, 'rb') as pickle_file:
        A = pickle.load(pickle_file)
    with open('/home/pracsys/catkin_ws/src/beliefspaceplanning/nn_model/data/acrobot_ao_rrt_traj' + tr, 'rb') as pickle_file:
