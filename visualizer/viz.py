...
# plt.gca().add_patch(rectangle)
rectangle = plt.Rectangle((-V.B, -1*V.YSIZE), 2*V.B, V.YSIZE/2, fc='b')
plt.gca().add_patch(rectangle)
rectangle = plt.Rectangle((-V.B, -0.5*V.YSIZE), 2*V.B, V.YSIZE/2, fc='m')
plt.gca().add_patch(rectangle)
rectangle = plt.Rectangle((-V.B, -0.), 2*V.B, V.YSIZE/2, fc='g')
plt.gca().add_patch(rectangle)
rectangle = plt.Rectangle((-V.B, 0.5*V.YSIZE), 2*V.B, V.YSIZE/2, fc='c')
plt.gca().add_patch(rectangle)
