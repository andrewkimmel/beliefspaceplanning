...
class svm_failure():
    ...
    def load_data(self):
        ...
        File = 'svm_data_' + self.mode + '_v' + str(var.data_version_) + '_d' + str(var.dim_-2) + '_m' + str(var.stepSize_) + '.obj' # <= File name here!!!!!

        self.postfix = '_v' + str(var.data_version_) + '_d' + str(var.dim_-2) + '_m' + str(var.stepSize_)
